...
import { createApplySpellHandler } from "./handlers/spells";
import {
  adventures,
  adventureChapters,
  adventureLocations,
...
export async function registerRoutes(httpServer: Server, app: Express): Promise<Server> {
  ...
  app.post('/api/rooms/:code/spells/apply', isAuthenticated, createApplySpellHandler(storage, broadcastToRoom));
